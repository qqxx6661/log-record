...
public class TestService {
    ...
    @OperationLog(bizId = "'1'", bizType = "'testConstantWithSpEL'", tag = "T(cn.monitor4all.logRecord.springboot.test.bean.TestConstant).TYPE1")
    public void testConstantWithSpEL() {
    }

    @OperationLog(bizId = "'1'", bizType = "'testEnumWithSpEL1'", tag = "T(cn.monitor4all.logRecord.springboot.test.bean.TestEnum).TYPE1")
    public void testEnumWithSpEL1() {
    }

    @OperationLog(bizId = "'1'", bizType = "'testEnumWithSpEL2'", tag = "T(cn.monitor4all.logRecord.springboot.test.bean.TestEnum).TYPE1.key")
    public void testEnumWithSpEL2() {
    }

    @OperationLog(bizId = "'1'", bizType = "'testEnumWithSpEL3'", tag = "T(cn.monitor4all.logRecord.springboot.test.bean.TestEnum).TYPE1.name")
