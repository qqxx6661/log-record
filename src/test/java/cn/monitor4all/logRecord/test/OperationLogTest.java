...
public class OperationLogTest {
    ...
    public void testMethodWithNoParam() {
        TestHelper.addLock("testMethodWithNoParam");
        testService.testMethodWithNoParam();
        TestHelper.await("testMethodWithNoParam");
        LogDTO logDTO = TestHelper.getLogDTO("testMethodWithNoParam");

        Assertions.assertEquals(logDTO.getMsg(), "testMethodWithNoParam");
    }

    @Test
    public void testMethodWithParam() {
        TestHelper.addLock("testMethodWithParam");
        testService.testMethodWithParam(new TestUser(1, "张三"));
        TestHelper.await("testMethodWithParam");
        LogDTO logDTO = TestHelper.getLogDTO("testMethodWithParam");

        Assertions.assertEquals(logDTO.getMsg(), "{\"id\":1,\"name\":\"张三\"}");
    }

    @Test
    public void testMethodWithNoReturn() {
        TestHelper.addLock("testMethodWithNoReturn");
        testService.testMethodWithNoReturn(new TestUser(1, "张三"));
        TestHelper.await("testMethodWithNoReturn");
        LogDTO logDTO = TestHelper.getLogDTO("testMethodWithNoReturn");
